...
BaseGameCharacterDetails.DoDoomsdayProfession = function()
    ...
    doomsdayprepper:addXPBoost(Perks.Nimble, 2)
    doomsdayprepper:addXPBoost(Perks.Lightfoot, 2)
    doomsdayprepper:addXPBoost(Perks.Sneak, 2)

    doomsdayprepper:addXPBoost(Perks.Axe, 2)
    doomsdayprepper:addXPBoost(Perks.Maintenance, 2)
